...
config = {
	...
	"default_code":"gbk",
	#禁止的后辍
	"forbidden_suf":["rar","pdf","jpg","png","zip","doc","xls","css","js","php"],
	#禁止包含的字符串
	...
	"cut_list":["#"],
	#动态页保留的参数
	#example {"http://www.soku.com/v":["curpage","keyword","limit_date","orderby"]}
	"params_keep":{},
	
	#页面匹配正则
	"link_type_config":{
		"detail":"^http://www.23us.com/book/[\d]*$",
	...
	"picker":{
		common.G_PAGETYPE["detail"]["type"]:{
			...
			"path":{
				#普通结果
				"title":{"key":"""/html/body//h1[@class="article-title"]/a/text()"""},
				#有对结果做处理
